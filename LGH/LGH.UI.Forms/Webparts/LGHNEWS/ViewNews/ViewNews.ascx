...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewNews.ascx.cs" Inherits="LGH.UI.Forms.Webparts.LGHNEWS.ViewNews.ViewNews" %>
    ...
    <asp:UpdatePanel runat="server" ID="updPanel">
        <ContentTemplate>
                    ...
                    <div class="main_content">		
                        <h2>                            <span class="title">News</span>                            <span id="spanCarousel" runat="server" class="addnew glyphicon glyphicon-plus-sign pull-right"><a href="/Pages/AddNews.aspx" class="a_new">Add New</a></span>
                        </h2>
