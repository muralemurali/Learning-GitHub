...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewCarousel.ascx.cs" Inherits="LGH.UI.Forms.Webparts.CAROUSEL.ViewCarousel.ViewCarousel" %>
    ...
    <asp:UpdatePanel runat="server" ID="updPanel">
        <ContentTemplate>
                    ...
                    <div class="main_content">		
                        <h2>                            <span class="title">Carousels</span>                            <span id="spanCarousel" runat="server" class="addnew glyphicon glyphicon-plus-sign pull-right"><a href="/Pages/AddCarousel.aspx" class="a_new">Add New</a></span>
                        </h2>
                        <asp:GridView runat="server" ID="gridCarousel" Width="100%" AutoGenerateColumns="False" GridLines="None"
                            ...
                            <Columns>
                                <asp:BoundField HeaderText="ID" DataField="ItemId" HeaderStyle-CssClass="GridHeaderStyle" ItemStyle-CssClass="GridItemStyle" />
                                  <asp:TemplateField HeaderText="Image" ItemStyle-CssClass="sseGridStylesImageClass" ItemStyle-Width="20%">
                                     <ItemTemplate>
                                         <a  id="CarouselLink" runat="server" href="#">  <img id="img" src='<%# Eval("CarouselImage") %>' alt="" /></a>
                                     </ItemTemplate>
                                 </asp:TemplateField>
                                <asp:TemplateField HeaderText="Title" ItemStyle-Width="20%">
                                    <ItemTemplate>

                                        <asp:Label runat="server" ID="lbltitle" Text='<%# Eval("CarouselUrl") %>' Visible="false"></asp:Label>
                                        <asp:HyperLink ID="hpltitle"  runat="server" Text='<%#Eval("CarouselTitle")%>' ForeColor="Blue" Font-Underline="true" ></asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Description" ItemStyle-Width="50%" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblDescription" Text='<%# Eval("CarouselDescription") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
